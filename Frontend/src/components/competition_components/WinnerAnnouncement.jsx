const WinnerAnnouncement = ({ username, profilePic, recipeTitle, recipeImage, totalVotes, score }) => {
  return (
    <div className="bg-gray-100 rounded-lg shadow-lg w-full mb-6 h-96 p-4">
      ...
      <div className="grid grid-cols-3 gap-10 place-content-center rounded-lg mb-6 w-full p-4">
        ...
        <div className="flex flex-col items-center justify-center">
          <img 
            src={recipeImage} 
            alt={`${recipeTitle}`} 
            className="w-64 h-40 rounded-lg object-cover border-4 border-white shadow-lg mb-2"
          />
          <h3 className="text-2xl font-semibold text-gray-700">{recipeTitle}</h3>
        </div>
